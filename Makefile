...
bfscript2.o: bfscript2.cpp functions.hpp includes.hpp code_generator.hpp color.hpp pointer.hpp
	g++ -c bfscript2.cpp

functions.o: functions.cpp functions.hpp includes.hpp
	g++ -c functions.cpp

code_generator.o: code_generator.cpp code_generator.hpp includes.hpp pointer.hpp
